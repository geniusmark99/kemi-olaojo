            ...
            <div class="mt-7 bg-white border border-gray-200 rounded-xl shadow-sm">
                ...
                <div class="p-4 sm:p-7">
                    <div class="text-center">
                        <h1 class="block text-2xl font-bold text-gray-800">Verify Login Token</h1>
                    ...
                    <div class="mt-5">
                        <!-- Form -->
                        <form action="{{ route('admin.verify.token') }}" method="POST">
                            @csrf
                            <div class="grid gap-y-4">
                                <!-- Form Group -->
                                <div>
                                    <label for="token" class="block text-sm mb-2">Enter Token</label>
                                    <div class="relative">
