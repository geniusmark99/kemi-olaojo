            ...
            <div>
                ...
                <div class="mx-10 flex justify-center mt-10">
                    <form action="{{ route('admin.questions.update', $question->id) }}" method="POST"
                        enctype="multipart/form-data" class="bg-white shadow rounded w-full lg:w-auto lg:p-6">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="bg-white w-full lg:min-w-[600px] p-4 rounded-md mt-5">
                            <div class="flex flex-col gap-y-5 mb-10">
                                <div class="flex items-center justify-between">
                                    ...
                                    <div class="flex gap-x-4">
                                        ...
                                        <button type="submit"
                                            class="px-2.5 py-1 rounded-md bg-blue-500 text-white ">Update</button>
                                    </div>
                            ...
                            <div class="mt-4 flex flex-col gap-y-2">
                                ...
                                <div class="space-y-4">
                                    <div>
                                        <label for="option_a" class="block font-medium">Course ID</label>
                                        <input type="text" name="course_id" id="course_id"
                                            value="{{ old('course_id', $question->course_id) }}"
